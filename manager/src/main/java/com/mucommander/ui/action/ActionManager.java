...
import com.mucommander.ui.action.impl.CutFilesToClipboardAction;
...
import com.mucommander.ui.action.impl.PasteFromArchiveToFilesFromClipboardAction;
...
//    	registerAction(new CommandAction.Descriptor(),           		     new CommandAction.Factory());
    	...
    	registerAction(new CutFilesToClipboardAction.Descriptor(),         new CutFilesToClipboardAction.Factory());
...
//    	registerAction(new OpenLocationAction.Descriptor(),          	    new OpenLocationAction.Factory());
    	...
    	registerAction(new PasteFromArchiveToFilesFromClipboardAction.Descriptor(),          new PasteFromArchiveToFilesFromClipboardAction.Factory());
